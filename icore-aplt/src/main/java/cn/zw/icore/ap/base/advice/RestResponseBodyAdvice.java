package cn.zw.icore.ap.base.advice;
...
//    private String excludePackageStr;
    ...
    public boolean supports(@NotNull MethodParameter returnType,
        ...
        return hasResponseBody && hasRestController && isNeedWrap(returnTypeContainingClass.getPackage().getName());
    }
...
//        String allExcludePackageStr = //StringUtils.joinWith(delimiter, excludeFrameworkPackageStr, excludePackageStr);
        return false;//!StringUtils.startsWithAny(packageName, StringUtils.split(allExcludePackageStr, delimiter));
    }
